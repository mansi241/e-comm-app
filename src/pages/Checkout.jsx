...
import { Container, Typography, Toolbar, Box, Paper, Stepper, Step,StepLabel, Button, Avatar, useTheme, TextField, createTheme, ThemeProvider } from '@mui/material'
    ...
    <Container component="section" maxWidth="lg" sx={{mb: 4}}>
        <Paper variant="outlined" sx={{my:{xs:3, md:6}, p:{xs:2, md:3}}}>
            ...
            </Stepper>
            {
                ...
                <Typography>Your order number is #D1G42634. We have emailed you the details regarding your order confirmation.</Typography>
